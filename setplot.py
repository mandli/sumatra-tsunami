...
#--------------------------
    ...
    plotitem.patchedges_show = 1
    plotaxes.xlimits = [65.0, 130.0]
    plotaxes.ylimits = [-25.0, 25.0]
    ...
    #-----------------------------------------
    # Figure for Fault Movement
    #-----------------------------------------
    plotfigure = plotdata.new_plotfigure(name="Sea-Floor Displacement", 
                                         figno=400, type='other_figure')

    def plot_sea_floor_displacement():
        pass
